  ...
  return (
    <div className="relative">
        ...
        <header className="max-w-6xl mx-auto flex items-center justify-between p-4 pb-10">
            <img src="/epicflix-logo.png" alt="Epicflix Logo" className="w-28 md:w-42"/>
        ...
        <div className="flex flex-col items-center justify-center text-center py-40 text-white max-w-6xl mx-auto">
            ...
            <form className="flex flex-col md:flex-row gap-4 w-1/2" action="" onSubmit={handleFormSubmit}>
        ...
        <div className="py-10 bg-black text-white">
            <div className="flex max-w-6xl mx-auto items-center justify-center md:flex-row flex-col px-4 md:px-2">
                ...
                <div className="flex-1 text-center md:text-left">
                    <h2 className="text-4xl md:5xl font-extrabold mb-4">Enjoy on your TV</h2>
        ...
        <div className="py-10 bg-black text-white">
            <div className="flex max-w-6xl mx-auto items-center justify-center md:flex-row flex-col px-4 md:px-2">
                {/*left side*/}
                <div className="flex-1 text-center md:text-left">
                    <h2 className="text-4xl md:5xl font-extrabold mb-4">Watch everwhere</h2>
